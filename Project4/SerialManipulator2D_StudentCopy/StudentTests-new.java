class StudentTests {
    ...
    static void testProportionalJointAngleExtended() {
        double[] q = {0.2, 0.2, 0.2};
        double[] qd = {0.5, 0.5, 0.5};
        double Kp = 0.05;
        double[] res = SerialLink2.proportionalJointAngleController(q, qd, Kp);
        double[] expResult = {0.215, 0.215, 0.215};
        assertArrayEquals(expResult, res, DEFAULT_TOL, "testProportionalJointAngleExtended");
    }
    
    static void testProportionalJointAngleZero() {
        double[] q = {0.0, 0.0, 0.0};
        double[] qd = {0.0, 0.0, 0.0};
        double Kp = 0.1;
        double[] res = SerialLink2.proportionalJointAngleController(q, qd, Kp);
        double[] expResult = {0.0, 0.0, 0.0};
        assertArrayEquals(expResult, res, DEFAULT_TOL, "testProportionalJointAngleZero");
    }
    
    static void testProportionalJointAngleZeroKZero() {
        double[] q = {0.0, 0.0, 0.0};
        double[] qd = {0.0, 0.0, 0.0};
        double Kp = 0;
        double[] res = SerialLink2.proportionalJointAngleController(q, qd, Kp);
        double[] expResult = {0.0, 0.0, 0.0};
        assertArrayEquals(expResult, res, DEFAULT_TOL, "testProportionalJointAngleZeroKZero");
    }
    ...
    static void run() {
        ...
        testProportionalJointAngleExtended();
        testProportionalJointAngleZero();
        testProportionalJointAngleZeroKZero();
    }
}